...
=== robbery_questions_loop ===
    ...
    *    ["The thefts used to occur after dark."]
        -- CHR_DID_REL
        "Until recently," he says, "the robberies were all at night. Recently, though, one was stolen during the day. Maybe the thieves are willing to risk it, now that fewer people are around the docks."
...
== look_mister ==
    -   CHR_TRO_REL
    -   CHR_DID_REL
    -   "Mr. MacKensie, we've got a big day ahead, so we gotta get going."

        "I hear ya," says Mac. "Got a big day myself. Lots of fish biting. Just grabbing supplies before I head north to catch some."
...
-   SYS_ACHIEVE_1_3
    -   CHR_MIA_REL
    -   "That looks like a lot of supplies for such a small boat," says Mia. "I hope he knows his capacity limits."
