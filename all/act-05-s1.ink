...
=== second_entry_cove (condition) ===
    ...
    // if Fog
        Mia and Alexis repeat the signal again—and again—but just as before there is no response from Julian and Troy. They try several more times over the next few minutes but there is no signal in reply.
        
            
            Mia and Alexis exchange worried looks.
            
            It's now gone past the second rendezvous hour, says Alexis. We need to make decision, says Alexis. 
    ...
    // if clear  
        ...
        They are an hour overdue from the first meeting time, says Alexis, "But they are only a few minutes overdue from the second meeting time." Alexis is fidgety and keeps checking her watch.
            ...
            * ["Pan, Pan Pan," she says.]
            using the signal (pronounced 'Pon') for an incident of less gravity than a Mayday signal. (Mayday is reserved for situation where loss of vessel or person is imminent." 
            
            This is the powered boat <i>Lakesong</i>, <i>Lakesong<i>, <i>Lakesong</i>, call letters Whiskey Sierra 2-3-2-3 Romeo Bravo. We are located near Kalkomey Isle and have 2 persons in kayaks who are overdue per our float plan. Over.
