...
//- SYS_SCENE_4_01
-   SYS_CHAP_09
The <i>Lakesong</i> approaches a large houseboat. Docked alongside it is another power boat, larger than the one they're towing, and several personal water craft (PWCs).
    ...
    * "Are those solar panels?" asks Mia[.], pointing to the roof of the houseboat.
    ...
    - "They're rated for towing, too, so we use them for water skiing." says Ian. "After we tie up, how about we do a little of each? It's the least we can do to say thanks for the tow."
    ...
    = board_houseboat
    -   SYS_SOUND_439
    -   Troy docks the <i>Lakesong,</i> and they all step aboard the houseboat to help Ian to secure his damaged speedboat.
...
-   SYS_ACHIEVE_6_1
    - "I'll give a quick PWC overview," says Ian. "Don't worry—despite what you saw this morning, I really do know what I'm doing when it comes to jet skiing."
