...
-   In the open waters away from the island, the fog clears, giving Mia and Alexis good visibility from the deck of the Lakesong.
    ...
    -   (opts)
        ...
        * (loops) [Alexis loops in wide circles.] {The boat cruises nicely, making wide, crisscrossing loops, and the time passes quickly as the girls enjoy taking turns at the wheel.|"I couldn't fall asleep last night, so I finished the boat education course and got my certificate." Alexis smiles at the excitement in Mia's voice, but then...} 
    ...
    -   "It's the creatures!" says Mia excited. "I mean the drones," she says correcting herself. 
        ...
        *  [The engine revs.]
        -   The engine revs and the boat zooms south.
            ...
            But Alexis had been planning for just this possibility, and has something up her sleeve. Estimating their current position with respect to the objects in pursuit...
            ...
            - (opts)
                ...
                * (adjusts) [Alexis adjusts course.] {Turning the wheel, Alexis adjusts course, putting the boat on a parallel course to island about a half mile off her port.| Alexis waits and watches the flying objects.}
...
== what_doing ==
    -   "Why are you slowing and turning?" asks Mia in a panic. "It's like you want them to catch us."
            ...
            - (opts)
                ...
                * (what) [Mia's face if full of doubt.] {"Trust me. I have a plan." Alexis makes a small adjustment to the throttle while keeping and eye on the pursuers.| "You know... a little cat and mouse action." }
...
== alexis_plan ==
    -   "Look, we know we can outrun them, because we proved that yesterday," Alexis says. "But I'm guessing they also have range limit and a limited flying time."
        ...
        *   ["Bingo!" says Alexis.] 
        ...
        -   Eventually, the creature-drones abandon their pursuit and peel off on a course straight back to the island. 
                ...
                * ["Running low on power I suspect," Alexis says.]
                "Carrying that extra weight of the creature disguise has to degrade their flight time and speed," says Alexis.
...
== investigate_flash_or_not ==
    -   "Do we investigate or not?" asks Alexis. 
        ...
        - (opts)
                ...
                *    [What it it's nothing.]
                    "If it's turn out to be nothing, then we'll have wasted time," says Mia. "And that signal looks far away which could mess up the plan to meet Julian and Troy on time."
...
== investigate_smoke_or_not ==
    -   "If we think that's from someone in distress," says Alexis, "we're going to have go that way and check it out."
...
== investigate  ==
    -   Having decided to investigate the mysterious {what_distract}, Alexis adjusts the <i>Lakesong's</i> course. 
        "This will take us back toward where were yesterday, right?" asks Mia.
            * ["Yes," says Alexis.]
                -> to_beach
        ...
        = approach_beach    
        -   In due time they do approach the same beach, but they are farther out where the water is deeper. They encounter no sandbars or other hazards.  
        ...
        
        {
            ...
            "How ironic," says Alexis. "I mean just yesterday {who_saw} said she'd never been to Kalkomey Isle."
                ** ["And by herself?" says Mia.] 
                    "Seriously, {who_saw} didn't strike the strong, independent type." Alexis says. 
                    -> spotted_us
...
== no_investigate ==
    -   Since it's not clear the {what_distract} they saw is actually some sort of signal, Mia and Alexis choose not to investigate. The are concerned about the safety of their own fellow crew members—Julian and Troy on the kayaks—and want to be certain to meet at planned time in the cove. 
    
            * [They wait and circle.]
            As they bide their time waiting to for the rendezvous, they see no more {what_distract} or anything else noteworthy. They are anxious to learn if Julian and Troy found anything interesting.
