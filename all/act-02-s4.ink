...
-   SYS_ACHIEVE_4_2
    ...
    -   With the <i>Lakesong's</i> engine stopped, Alexis and Julian carefully pull the first victim, a young woman, over the stern and onto the <i>Lakesong's</i> deck.
        ...
        -   CHR_MAU_REL
                ...
                "It felt like forever," says Maura. "Not sure how much longer I could have kept treading water."
        ...
        -   CHR_JUL_SML
        -   CHR_IAN_REL
        -   "At least the marine police didn't see you speeding out of port this morning, too." Julian has recognized Maura and Ian.
...
-   SYS_ACHIEVE_2_3
        ...
        -   "We weren't, I swear," Ian starts, but Captain Garcia's expression causes him to halt.
            ...
            * ["Well, maybe I was going a little fast," Ian amends.] "But nothing excessive," he hurries to add.
...
-   Captain Garcia performs several seated sobriety tests on Ian, closely observing Ian's gaze, cognitive ability, and coordination.
    ...
    * [Finally, Captain Garcia speaks.]
    ...
    - "Actually, we stopped your boat by jamming the propeller with a rope," says Captain Garcia. "Your engine is going to need some work."
...
//to here.
        ...
        - (done)
        -   CHR_TRO_REL
            * "Ok, let's" says Troy.[] "Get the boat rigged for tow." He points at Maura and Ian. "And you two definitely need to get into life jackets!"
