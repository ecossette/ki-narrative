...
=== discussion_after_houseboat ===
    // sound generic boat engine
    - As the <i>Lakesong's</i> skims the surface of the lake, the friends talk among themselves.
    //unless it's a hovercraft, why would it skim the surface. Does act two detail the conversation? I reckon you could cut this last line and end the act on 'open water'
