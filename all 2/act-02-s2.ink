...
== area_clear_satisfied ==
    ...
    -  Satisfied that the area is clear of traffic, Troy continues.
        ...
        "The steps we need to take to cast off depend on the direction of the wind or current," he says.
...
-   SYS_SCENE_4
    -   CHR_TRO_REL
    -   Troy eases the <i>Lakesong</i> away from the Laketown docks and steers it toward the channel that leads to open water.
 ...
 == depart_dock_q_loop ==
                    ...
                    *    "Why are we going so slow?"[] Julian looks bored.
                    //the question mark is enough of a signal. You don't need 'asks' always.
                        -- CHR_TRO_REL
                        -- CHR_JUL_SAD
                        "We're at 'Slow, No Wake' speed. It's required when you're operating around the docks and in the channel. Don't worry, we'll speed up once we're in open waters!"
                            // he isn't worried, so no need to assure him
                    *     "What is that clipped to your PFD?"[] asks Mia.
                        -- CHR_MIA_REL
                        -- CHR_TRO_REL
                            "That's the engine cut-off switch lanyard," says Troy. "It's a kill switch. If I were knocked away from the controls or tossed overboard, the lanyard will disconnect, stopping the engine."
...
== before_tro_can_fin ==
        ...
        -   The sound of a loud outboard motor cuts Troy off. A boat is rapidly overtaking the <i>Lakesong</i> on her starboard side.
            ...
            Neither the man driving the speeding boat or his passenger, a young woman, are wearing a PFD.
                ...
                * ["That was rude!" exclaims Mia.]
                    -- CHR_MIA_ANG
                    -- CHR_TRO_ANG
                    "Rude <i>and</i> reckless," adds Troy.
        ...
        = man_holds_on
            * Mac holds on[.], with both hands, keeping his body low and his feet spread. His boat comes close to capsizing, but fortunately his cargo was low and evenly distributed. And by keeping at least three points of contact with his boat, Mac minimized his risk of being thrown overboard.
...
== supplies_oceanside
            - (opts)
                ...
                *    (oceanside) ["Oceanside?"]
                    ...
                    {Alexis takes notice of the mention of Oceanside. "Some people think Oceanside is where the boat thieves are from," she says.|"Could be," says Troy, as he nudges the throttle forward to overtake Mac's boat.}
