...
-   SYS_CHAP_08
    ...
    //otherwise it sounded like the number of eyes was relevant
        ...
        -   The <i>Lakesong</i> slows. Now they can hear the whine of a boat motor coming from the area Mia pointed out.
                "Wait, is that boat going in circles?" wonders Alexis, squinting.
    ...
    = closer_look
        -   CHR_MIA_REL
        -   CHR_TRO_REL
        -   Troy eases the <i>Lakesong</i> into a right turn. "Somebody could be in trouble and need help," he says.
    ...
    = ignore_keep_going
        ...
        - "Let's just keep going," says Julian. "We already got a late start as it is."
            ...
            "But we can't leave the area if we think another boater may need help," says Troy.
            // unles you have to to replicate language used in a test, try to aim for natural speech (help, rather than assistance)

                    * ["Yeah. We don't have a choice," says Alexis.]
    ...
    = mean_no_choice
        ...
        //friends rarely use each other's names in conversation
            ...
            "Coast Guard navigation rules say we have to help," replies Alexis.
...
== it_is_cod ==
    -   CHR_ALX_ANG
    -   CHR_MIA_ANG
    -   "It's the Circle of Death," says Alexis.
        ...
        - CHR_TRO_REL
        - SYS_SOUND_404
        "I'll explain later. Mia, see if you can spot anyone in the water," commands Troy. He brings the <i>Lakesong</i> to a full stop a safe distance from the dangerously-circling boat.

            * [Troy reaches for the VHF radio.]
                        -> reaches_for_radio

        = reaches_for_radio
        -   The <i>Lakesong's</i> VHF radio is already tuned to Channel 16—the emergency channel. Troy has been quietly monitoring the channel since leaving the dock.
        ...
        = channel_68
        -   CHR_TRO_REL
        -   While Alexis, Mia and Julian continue to scan the surface for survivors, Troy provides the Marine Patrol officers with additional details on their estimated location.
            ...
            *   [The marine police respond.] "We are en route, <i>Lakesong</i>. ETA 10 minutes. Stay clear and let us know if the situation changes, over."
            ...
            -   CHR_MIA_REL
            -   CHR_TRO_REL
            -   "What would happen to someone who was thrown inside the circle?"

            -   "They'd be struck with the propeller, most likely," Troy says.
            ...
            -   Meanwhile the unmanned boat continues its dizzying loop. The sound grates on everyone's nerves, especially Julian's.
                ...
                - (opts)
                    *    ["How long will it go on like that?" asks Julian.]
                    //who says this?
                        -- CHR_JUL_REL
                        -- CHR_TRO_REL
                        "Until the engine runs out of gas." Troy squints at the boat. -> stop

                    *    (stop) ["There's no way to stop it?"] {"There's nothing safe we can do on our own," says Troy.|"The marine patrol might have a solution. We'll find out when they get here.}"

                    *    {stop} ["Let's look for the driver," says Alexis.] -> idea_circle
           ...
           -    CHR_ALX_SML
           -    CHR_TRO_REL
           - "Whoever was in the boat may have been thrown to the other side, where we can't see," says Alexis.
           // fairly certain this is a 'whoever' not 'whomever' (ditto earlier)

                Troy nods. "Good thinking. Let's circle around at a safe distance and look."
                //don't over describe actions. Player will fill in gaps. (Trust reader)

                    ** Troy eases the throttle forward[.], and the <i>Lakesong</i> begins a slow, circular sweep of the area.
            ...
            = see_head
                ...
                - Mia points in the distance a head bobbing in the water.
                    ...
                    "Who knows how long they were treading water before we got here?" worries Mia.
