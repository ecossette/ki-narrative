...
=== inspect_for_damage
    ...
    -   "So how's everyone feeling after our first visit to Kalkomey Isle?" Mia asks her friends. 
        ...
        -   (opts)
                ...
                * ["Very happy," says Julian.]
                -   CHR_MIA_SUR
                -   CHR_JUL_SML
                    "Happy?" asks a suprised Mia. 
                    "Yes, I'm happy that my first visit to Kalkomey Isle is also my <i>last</i> visit to Kalkomey Isle." 
                
                * ["Intrigued," says Alexis.]
                -   CHR_ALX_REL
                    "A dissapearing boat? Flying creatures? That's intriguing," says Alexis. {enter_the_path: "And from what we saw on the beach, Kalkomey Isle is not abandoned."}
                
                * ["Frustrated," says Troy.]
                -   CHR_TRO_REL
                    "If we knew the engine was going to OK," says Troy, briefly looking back toward the island in the far distance, "we might have gotten a better look at those creatures." 
        ...
        =  mia_no_suprise_dark
        -   CHR_MIA_REL
        -   "After the day we've had, I think being out on the lake after dark is anti-climatic," she says.
    ...
    = no_discuss_the_isle
    -   Everyone is lost in their thoughts as the Lakesong cruises steadily along. Nobody says anything for several minutes until Troy remembers the photos.
...
== mia_photos_look ==
    -   CHR_TRO_REL
    -   CHR_MIA_REL
    -   Mia takes out her phone. "Like I said the light was poor and the creatures were moving," she says as she swipes through her recent photos. "This one isn't too bad."
        ...
        -   CHR_TRO_REL
     -   CHR_MIA_REL        
        -  "Well, it gets pretty pixalated when I zoom in." Mia passes the phone around for the others to see. They all take turns pinching and spreading their fingers on the screen trying to get the best look. 
        ...
        -   CHR_TRO_REL
        -   CHR_JUL_REL
        -   "Even pixelated, I'm pretty sure there is somthing inorganic at work here," says Troy. 
        ...
        -   "No, Julian," says Alexis. "Troy means not from living organisms."
        ...
        -   "When I get home I may be able to clean up the photo a bit on my computer."
             ...
             * [Darkness sets in.] 
                -- CHR_TRO_REL
                Troy texts his brother Vincent to update him on the change in their float plan to account for the later return to shore. 
...
== after_docking_ahoy
    ...
    -   With the Lakesong successfully docked, Troy instructs his three friends on the tasks needed to secure the boat for the night.
        ...
        *   "Ahoy there!" a voice shouts. 
        ...
        = mac_approach
        -   CHR_DID_REL
        -   Mac approaches the Lakesong. "I haven't seen weather like that in years."        
        ...
        -   CHR_DID_REL
        -   CHR_TRO_REL
            "Yep, those are the owners. The Crowley's. They owned the <em>Dee Stress</em> an—"
        
            "An outboard cabin cruiser in the same length class as the Lakesong," says Troy. Mac nods. 
            
                * ["But that's not all..." Mac says with a dramatic pause.] -> reward_announce
                
        = reward_announce
        -   CHR_DID_SML
        -   "There's now a reward for anyone who offers information that leads to an arrest," says Mac, looking at each of the friends in turn. "And the reward is a boat... a big one, too."
...
== allow_man_leave ==
    -   CHR_TRO_SUR
    -   Mac departs, and the friends finish up securing the boat for the night.

    -   "Anyone up for taking a shot at that reward?" asks Troy after double-checking the mooring lines.
                    
       - (opts)
            * ["Depends on what's involved," says Julian.]
            --  CHR_JUL_REL
            --  CHR_TRO_SML
                "Like would taking a shot at said reward include encountering flying creatures again?" asks Julian. 
            ...
            * ["Sure, but where would we start?" asks Alexis.]
                -- CHR_ALX_REL
            
                 {
                    - robbery_questions_loop || ask_robbery_questions && go_to_island:
                        "The only clues we have are what little the man told us and what we saw on the beach," says Alexis. 
                    ...
                    - robbery_questions_loop || ask_robbery_questions:
                        "The only clues we have are what little the man told us," says Alexis. 
                ...
                "Don't forget the dissapearing boat," says Troy. "A boat that was the same type as the one stolen today from the Crowleys."
...
== jul_scratches_reluctant ==
    ...
    = man_made_theory
    -   CHR_TRO_SUR
    -   "What if that is a propeller we see in the pixelated photo and the creatures are man-made?"  
            - (opts)
...
== jul_rejects_theory ==
    -   CHR_JUL_REL
    -  "I'm not sure how that is good news, bro," says Julian. "Scary people creating scary machines to scare people from the island? All I'm hearing is a whole lot of 'scary'."
    ...
    = curious_cat
    -   CHR_JUL_SAD 
    -   "And curiousity killed the cat is how I heard it."
    
        It's clear Julian is reluctant to return to the island, so his three friends decide to:
    ...
    -   "If Julian doesn't want to go, then we shouldn't try to talk him into it," says Mia.
        ...
        "I agree," says Troy. "This missions needs to be completely voluntary..." Troy pauses.
    ...
    -   CHR_MIA_REL
    -   CHR_JUL_REL
    -   "Don't forget we were able to outrun the creatures, or drones, with the Lakesong," says Mia. "And the fog will conceal us as well."
 ...
 === meet_0900 ===  
    ...
    -   "Great! Let's meet here at oh nine hundred," says Troy. {is_radio_damaged: "I'll need to replace the VHF antennae and radio, but I should be able to do that by nine."}
            ...
            *  [The friends finish securing the Lakesong and depart for the night.]
            
            -> day_two_begins
            
=== day_two_begins ===
    -   temp / FPO for Act 4 beginning
    ->  DONE
